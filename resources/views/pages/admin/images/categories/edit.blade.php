...
@section('breadcrumb')
    <nav id="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('admin.images.categories.index') }}">دسته‌بندی</a></li>
...
@section('panel')
    <div class="card">
        <form class="card-body rtl" method="post" action="{{ route('admin.images.categories.update', $category) }}">
            @method('put')
            @csrf
            <div class="row">
