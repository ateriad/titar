                                ...
                                <div class="large-12 columns inner-flex-video padding-0">
                                    <div class="video-single-img">
                                        <a href="{{ route('videos.show', $video) }}">
                                            <img class="w-100 h-100" src="{{ $video->attribute('banner') }}"
                                                 alt="{{ $video->title }}"/>
                                            <div>
                                                <button class="button">
                                                    <span><i class="fa fa-play-circle"></i>مشاهده ویدئو</span>
                                                </button>
                                            </div>
                                        </a>
                                    </div>
                                        ...
                                        <div class="media-object-section object-second">
                                            <div class="author-des clearfix">
                                                <div class="post-title">
                                                    ...
                                                    <p>
                                                        <span>
                                                            {{ jDate($video->created_at) }}
                                                            <i class="fa fa-clock"></i>
                                                        </span>
                                                        <span>
                                                            {{ count($video->product->visits) }}
                                                            <i class="fa fa-eye"></i>
                                                        </span>
                                                        <span>
                                                            {{ $video->product->likes() }}
                                                        ...
                                                        <span>
                                                            {{ $video->product->dislikes() }}
                                                            <i class="fa fa-thumbs-down"></i>
                                                        </span>
                                                        <span>
                                                            {{ count($video->product->comment) }}
                                    ...
                                    <div class="description showmore_one">
                                        ...
                                        <div class="categories">
                                            ...
                                            @foreach($video->categories as $c)
                                                <a href="{{ route('videos.categories.show', $c->id) }}"
                            ...
                            <div class="row secBg">
                                <div class="large-12 columns">
                                    ...
                                    <div class="comment-box">
                                        <div class="media-object stack-for-small">
                                            @if(auth()->id())
                                                <form method="post" action="{{ route('videos.comments', $video->id) }}"
                                            ...
                                            <div class="row">
                                                <div class="large-12 columns">
                                                    <div class="alert alert-secondary rtl">
                                                        هیچ دیدگاهی برای این ویدئو فرستاده نشده است.
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
