                                ...
                                <div class="large-12 columns inner-flex-video padding-0">
                                    <div class="video-single-img">
                                        <a href="{{ route('images.show', $image) }}">
                                            <img class="w-100 h-100" src="{{ $image->attribute('banner') }}"
                                                 alt="{{ $image->title }}"/>
                                            <div>
                                                <button class="button">
                                                    <span><i class="fa fa-play-circle"></i>مشاهده تصویر</span>
                                                </button>
                                            </div>
                                        </a>
                                    </div>
                                        ...
                                        <div class="media-object-section object-second">
                                            <div class="author-des clearfix">
                                                <div class="post-title">
                                                    ...
                                                    <p>
                                                        <span>
                                                            {{ jDate($image->created_at) }}
                                                            <i class="fa fa-clock"></i>
                                                        </span>
                                                        <span>
                                                            {{ count($image->product->visits) }}
                                                            <i class="fa fa-eye"></i>
                                                        </span>
                                                        <span>
                                                            {{ $image->product->likes() }}
                                                        ...
                                                        <span>
                                                            {{ $image->product->dislikes() }}
                                                            <i class="fa fa-thumbs-down"></i>
                                                        </span>
                                                        <span>
                                                            {{ count($image->product->comment) }}
                                ...
                                <div class="large-12 columns">
                                    ...
                                    <div class="description showmore_one">
                                        ...
                                        <div class="categories">
                                            ...
                                            @foreach($image->categories as $c)
                                                <a href="{{ route('images.categories.show', $c->id) }}"
                            ...
                            <div class="row secBg">
                                <div class="large-12 columns">
                                    ...
                                    <div class="comment-box">
                                        <div class="media-object stack-for-small">
                                            @if(auth()->id())
                                                <form method="post" action="{{ route('images.comments', $image->id) }}"
                                            ...
                                            <div class="row">
                                                <div class="large-12 columns">
                                                    <div class="alert alert-secondary rtl">
                                                        هیچ دیدگاهی برای این تصویر فرستاده نشده است.
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
...
@section('scripts')
    ...
    <script>
        $('#like, #dislike').click(function () {
            ...
            $.ajax({
                method: 'post',
                url: '{{ route('images.reactions', $image) }}',
                data: JSON.stringify({
                    type: type,
                }),
