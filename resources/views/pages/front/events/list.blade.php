                                    ...
                                    <div class="large-12 columns">
                                        <div class="row column head-text clearfix">
                                            <div class="pull-right large-6">
                                                <p>تعداد رویدادها : <span>{{ count($events) }}</span></p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            @if(count($events) == 0)
                                                <div class="large-12 columns">
                                                    <div class="alert alert-dark" role="alert">رویدادیی بارگذاری
                                                        نشده است.
                                                    </div>
                                                </div>
                                            @else
                                                                ...
                                                                <div class="item large-3  columns">
                                                                    <div class="post thumb-border">
                                                                        <div class="post-thumb">
                                                                            <img
                                                                                src="{{ $event->attribute('thumbnail')  }}"
                                                                                alt="{{ $event->title }}">
                                                                            <a href="{{ route('events.preview', $event) }} "
                                                                               class="hover-posts">
                                                                                <span>مشاهده رویداد</span>
                                                                            </a>
                                                                            <div class="video-stats clearfix">
                                                                                <div class="thumb-stats pull-left">
                                                                                    <span>{{ $event->product->likes() }}</span>
                                                                                    <i class="fa fa-thumbs-up"></i>
                                                                                </div>
                                                                                <div class="thumb-stats pull-left">
                                                                                    <span>{{ $event->product->dislikes() }}</span>
                                                                                    <i class="fa fa-thumbs-down"></i>
                                                                                </div>
                                                                                <div class="thumb-stats pull-right">
                                                                                    <span>{{ count($event->product->comment) }}</span>
                                                                        ...
                                                                        <div class="post-des">
                                                                            <h6>
                                                                                <a href="{{ route('events.preview', $event) }} ">{{ $event->title }}</a>
                                                                            </h6>
                                                                            <div class="post-stats clearfix">
                                                                                <p class="pull-right">
                                                                                    <i class="fa fa-clock"></i>
                                                                                    <span>{{ jDate($event->created_at) }}</span>
                                                                                </p>
                                                                                <p class="pull-right">
                                                                                    <i class="fa fa-eye"></i>
                                                                                    <span>{{ count($event->product->visits) }}</span>
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                        ...
                                        <div class="row">
                                            <nav class="col text-center pt-2">{{ $events->render() }}</nav>
                                        </div>
                                    </div>
                                </div>
                            </section>
